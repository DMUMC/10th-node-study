export const ErrorCode = {
  ...
  // Auth
  AUTH_INVALID_CREDENTIALS: { status: 401, code: 'AUTH4001', message: '이메일 또는 비밀번호가 올바르지 않습니다.' },
  ...
  MEMBER_REQUIRED_FIELD: { status: 400, code: 'USER4003', message: '필수 입력값이 누락되었습니다.' },
  ...
  MISSION_STATUS_REQUIRED: { status: 400, code: 'MISSION4004', message: 'status는 필수 입력값입니다.' },
